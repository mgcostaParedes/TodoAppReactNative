    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.footer}>
          ...
          <TextInput style={styles.textInput} onChangeText={(noteText) => this.setState({noteText})} value={this.state.noteText} placeholder="Write here.." placeholderTextColor="white" underlineColorAndroid="transparent"></TextInput>
